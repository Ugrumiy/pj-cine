		...
		<div class="wrapper-outer-example">
			<div class="wrapper-inner example clearfix">
				...
				<div class="example-text-container clearfix">
					<div class="col-left">
						<iframe width="100%" height="380" src="https://www.youtube.com/embed/p4zluA60hjs" frameborder="0" allowfullscreen style='max-width:650px;' class='ytube'></iframe>
					</div>
					<div class="col-right">
